"""Prompt-optimization primitives for the ScikitDocs starter (REQ-073, M22).
...
The cross-module contract is the `X-Client-Id` header REQ-071 added to
...
M22's `pick_variant(client_id, traffic_split)` hashes it through
...
M11 RAGAS eval harness fires un-headered requests, for instance —
...
M21 concept-script (V2 + V3) for the conceptual framing.
"""
