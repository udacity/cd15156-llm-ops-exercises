"""CLI entry for the blue/green corpus migration.
...
form of blue/green, which exercises the cutover mechanism end to
end. Pass ``--tag <version>`` to point the migration at a
