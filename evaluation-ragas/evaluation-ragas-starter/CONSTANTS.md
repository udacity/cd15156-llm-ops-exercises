...
| `MODEL_SIMPLE` | `gpt-4o-mini` | 29 | Cheaper model for the simple-vs-complex router; also the RAGAS judge model. |
...
| `DEFAULT_TOP_K` | `5` | 34 | Default retrieval depth; the eval sweep varies k∈{3,5,10}. |
