...
(`constants.CLIENT_ID_HEADER`). When present, it is used as the
bucketing key for sticky-by-user variant assignment. A contract test in
`tests/test_smoke.py` verifies the header is plumbed end-to-end.
