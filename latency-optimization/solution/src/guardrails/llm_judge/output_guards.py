"""LLM-as-judge hallucination check (REQ-072, M20).
...
so the M13 dashboard surfaces them in a separate bucket from real
answers. Exercise 2 in M20 sweeps the judge's behavior against a 10-row
golden cohort.
"""
