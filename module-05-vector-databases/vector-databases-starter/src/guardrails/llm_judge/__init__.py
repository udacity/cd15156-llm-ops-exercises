"""LLM-as-judge output guard — hallucination scanning.

The judge is a gpt-4o-mini call constructed at module load time with
the Vocareum-aware ``base_url`` discipline (the
...
sources do not mention. The rubric is written for the documentation
Q&A workload.
"""
